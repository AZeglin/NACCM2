<%@ Page Title="" Language="C#" MasterPageFile="~/ContractView.Master" StylesheetTheme="CMStandard" AutoEventWireup="true" CodeBehind="ContractSales.aspx.cs" Inherits="VA.NAC.CM.ApplicationStartup.ContractSales" %>
...
<asp:Content ID="ContractSalesContent" ContentPlaceHolderID="ContractViewContentPlaceHolder" runat="server">
          ...
          <td style="vertical-align:top;" >
                <asp:FormView ID="SalesHeaderFormView" runat="server" Width="100%" Height="100%" DefaultMode="Edit" OnPreRender="SalesHeaderFormView_OnPreRender"  >
                    ...
                    <table class="OutsetBox" style="width:100%;">
                            ...
                            <tr>
                                <td>
                                   <asp:Button runat="server" ID="AddSalesButton" CssClass="multilineButtonText" Height="54px" Width="140px" Text="Add Sales" OnClick="AddSalesButton_OnClick"  />
                                </td>
  
                                <td>                                            
                                   <asp:Button runat="server" ID="ExportUploadSalesButton" CssClass="exportUploadSalesButton" Height="54px"  Width="140px"  Text="Export/Upload Sales"  />
                                </td>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td >
                                               <asp:Button runat="server" ID="ViewIFFSalesComparisonButton"  Width="200px" Text="View IFF/Check Comparison" OnClick="ViewIFFSalesComparisonButton_OnClick"  />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td >
        ...
        <tr>
            <td style="vertical-align:top;" >
                ...
                <asp:Panel ID="SalesGridPanel" runat="server" Width="100%" Height="100%"  OnPreRender="SalesGridPanel_OnPreRender" >
                    ...
                    <div id="SalesSummaryGridViewDiv"  runat="server"  style="border:3px solid black; height:390px; overflow: scroll" onscroll="javascript:setSalesScrollForRestore( this );"  onkeypress="javascript:setSalesScrollForRestore( this );"  >
                        ...
                        <ep:GridView ID="SalesSummaryGridView" 
                                ...
                                <Columns>   
                                        ...
                                        <asp:TemplateField ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Center" >  
                                          <ItemTemplate>
                                            <asp:Button runat="server"  ID="EditSalesBySINButton" Text="Edit Sales By SIN" OnDataBinding="EditSalesBySINButton_DataBinding" OnCommand="SalesSummaryGridView_ButtonCommand" CommandName="EditSalesBySINButton" CommandArgument='<%# Container.DataItemIndex + "," +  Eval("Quarter_ID") + "," +  Eval("Year") + "," +  Eval("Qtr") %>' ButtonType="Button" CssClass="multilineButtonText" Width="100px" >            
                                                </asp:Button >                                    
                                          </ItemTemplate>
                                          <EditItemTemplate>
                                            <asp:Button runat="server"  ID="EditSalesBySINButton" Text="Edit Sales By SIN" OnDataBinding="EditSalesBySINButton_DataBinding" OnCommand="SalesSummaryGridView_ButtonCommand" CommandName="EditSalesBySINButton" CommandArgument='<%# Container.DataItemIndex + "," +  Eval("Quarter_ID") + "," +  Eval("Year") + "," +  Eval("Qtr") %>' ButtonType="Button" CssClass="multilineButtonText" Width="100px" >            
