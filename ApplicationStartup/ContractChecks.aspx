<%@ Page Title="" Language="C#" MasterPageFile="~/ContractView.Master" StylesheetTheme="CMStandard" AutoEventWireup="true" EnableEventValidation="false"  CodeBehind="ContractChecks.aspx.cs" Inherits="VA.NAC.CM.ApplicationStartup.ContractChecks" %>
        ...
        <tr>
            <td style="vertical-align:top;" >
                ...
                <asp:Panel ID="CheckGridPanel" runat="server" Width="100%" Height="100%"  OnPreRender="CheckGridPanel_OnPreRender" >
                    ...
                    <div id="CheckGridViewDiv"  runat="server"  style="border:3px solid black; height:420px; overflow: scroll" onscroll="javascript:setCheckScrollForRestore( this );"  onkeypress="javascript:setCheckScrollForRestore( this );"  >
                        ...
                        <ep:GridView ID="CheckGridView" 
                                ...
                                <Columns>   
                                    ...
                                    <asp:TemplateField  HeaderText="Deposit Number"  ItemStyle-Width="10%" >
                                        <ItemTemplate>
                                            <asp:Label ID="depositNumberLabel" runat="server" Width="99%"   Text='<%# DataBinder.Eval( Container.DataItem, "DepositNumber" )%>'  CssClass="rightAlign" ></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <ep:TextBox ID="depositNumberTextBox" runat="server"  Width="94%"  Text='<%# DataBinder.Eval( Container.DataItem, "DepositNumber" )%>'  CssClass="rightAlign" ></ep:TextBox>                                     
                                        </EditItemTemplate>
                                    </asp:TemplateField>
