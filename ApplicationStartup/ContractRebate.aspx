        ...
        <tr>
            <td style="vertical-align:top;" >
                ...
                <asp:Panel ID="RebateGridPanel" runat="server" Width="100%" Height="100%"  OnPreRender="RebateGridPanel_OnPreRender" >
                    ...
                    <div id="RebateGridViewDiv"  runat="server"  style="border:3px solid black; height:262px; overflow: scroll" onscroll="javascript:setRebateScrollForRestore( this );"  onkeypress="javascript:setRebateScrollForRestore( this );"  >
